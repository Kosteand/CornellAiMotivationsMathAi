...
from Utilities.bandit_env import BanditEnv, CsvLoggingWrapper
...
def train(
    ...
    ----------
    groups:
        List of group instances (AlternatingGroup/MarginGroup/HeatmapGroup
        - see groups.py) passed to BanditEnv - defines the
