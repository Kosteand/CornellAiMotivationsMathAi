...
# 2026-08-19: this file (and its CSV) moved from src/ into src/data/, as
# part of a repo cleanup grouping the three-file architecture's CSVs with
# the modules that manage them. Inserting src/ (this file's parent's
# parent) onto sys.path keeps `from data.legacy_csv_data import ...`/
# `from data.pair_data import ...` below resolvable regardless of how
# this module ends up imported/run.
...
def migrate_group_data_from_legacy(g: int = 4, samples=None, seed=None,
    ...
    same rows."""
    from data.legacy_csv_data import INDIFFERENCE_RECORDS, get_weight_norm_record
    from data.pair_data import _old_spec_to_cache_key
