...
TESTS = [
    {
        ...
        "fixed_group": lambda value: MarginGroup(g=4, delta=1.0, value=value),
        "variable_group": lambda value: MarginGroup(g=4, delta=1.0, value=value),
    ...
    },
    {
        ...
        "incorrect_reward": 0.0,
        "fixed_group": lambda value: MarginGroup(g=4, delta=1.0, value=value),
        "variable_group": lambda value: MarginGroup(g=4, delta=0.25, value=value),
    ...
    },
    {
        ...
        "value_fixed": 1.0,
        "incorrect_reward": 0.0,
        "fixed_group": lambda value: MarginGroup(g=4, delta=1.0, value=value, err=0.0),
        "variable_group": lambda value: MarginGroup(g=4, delta=1.0, value=value, err=0.2),
    ...
    },
    {
        ...
        "value_fixed": 1.0,
        "incorrect_reward": 0.0,
        "fixed_group": lambda value: MarginGroup(g=4, delta=1.0, value=value, s=1.0),
        "variable_group": lambda value: MarginGroup(g=4, delta=1.0, value=value, s=5.0),
        # SAME absolute margin (delta=1.0) but a 5x larger random-score
    ...
    },
    {
        ...
        "incorrect_reward": 0.0,
        "fixed_group": lambda value: MarginGroup(g=4, delta=1.0, value=value),
        "variable_group": lambda value: MarginGroup(g=8, delta=1.0, value=value),
