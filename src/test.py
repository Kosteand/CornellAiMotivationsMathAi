...
env = SEnv.MazeEnv(low, high, spawn, target_awards, target_coords, heatMapTypes=[dummy_heatmap_ManhattanMid, dummy_Heatmap_Target_Dist, dummy_Heatmap_Target_Dist_Manhat, dummyRandomHHeatMap1])
