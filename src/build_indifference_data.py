...
Utilities.indifference_data.is_excluded_spec for the exact rule). Future
batch_summary runs should be folded in via
Utilities.indifference_data.append_batch_summary_csv(path) instead of
...
import sys
sys.path.insert(0, ".")
from Utilities.indifference_data import is_excluded_spec, parse_spec, FIELDNAMES
